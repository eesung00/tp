 ...
 */
public class ApplicationFindCommand extends ApplicationCommand {
    ...
    /**
     * Constructs ApplicationFindCommand object.
     ...
     */
    public ApplicationFindCommand(CompanyContainsKeywordsPredicate companyPredicate,
    ...
    public boolean equals(Object other) {
        return other == this // short circuit if same object
                ...
                && companyPredicate.equals(((ApplicationFindCommand) other).companyPredicate)
                && positionPredicate.equals(((ApplicationFindCommand) other).positionPredicate)); // state check
    }
}
