 ...
 */
public class ApplicationEditCommand extends ApplicationCommand {
     ...
     */
    public ApplicationEditCommand(Index index, EditApplicationDescriptor editApplicationDescriptor) {
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof ApplicationEditCommand)) {
            return false;
        }

        // state check
        ApplicationEditCommand e = (ApplicationEditCommand) other;
